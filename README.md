...
Apps generadas (Angular 21 zoneless + SCSS, NestJS 12 + Prisma 7 con adaptador pg, Vite 8 + Sass). Modelo de datos inicial en `database/` (árbol de unidades). Pendiente: alcance funcional y endpoints. Requiere `npm install` en `client/`, `services/api/` y `landing/`.
