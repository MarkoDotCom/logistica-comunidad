...
describe('Home', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [Home],
      providers: [provideSessionWith(ALL_PERMISSIONS), provideRouter([]), provideHttpClient(), provideHttpClientTesting()],
    }).compileComponents();
  ...
  it('should render one metric per count with its hint', async () => {
    ...
    expect(el.querySelectorAll('ui-card')).toHaveLength(4);
